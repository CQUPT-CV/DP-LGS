    ...
    $.extend({
        ...
        table: {
            ...
            imageView: function (value, height, width, target) {
                ...
                if ($.common.isNotEmpty(value)) {
                    ...
                    return $.common.sprintf("<img class='img-container img-xs' data-height='%s' data-width='%s' data-target='%s' src='data:image/png;base64,%s'/>", height, width, _target, value);
                } else {
        ...
        modal: {
            ...
            openOptions: function (options) {
                ...
                var _title = $.common.isEmpty(options.title) ? "System Info" : options.title;
