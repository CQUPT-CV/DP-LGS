...
import com.ruoyi.framework.shiro.web.filter.pass.PassFilter;
...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        // 对静态资源设置匿名访问
        filterChainDefinitionMap.put("/platform/upload", "anon");
        filterChainDefinitionMap.put("/platform/analysis", "anon");
        filterChainDefinitionMap.put("/platform/view", "anon");
        ...
        filters.put("pass", passFilter());
        shiroFilterFactoryBean.setFilters(filters);

        // 所有请求需要认证
        filterChainDefinitionMap.put("/platform/upload", "pass");
        filterChainDefinitionMap.put("/platform/analysis", "pass");
        filterChainDefinitionMap.put("/platform/view", "pass");
